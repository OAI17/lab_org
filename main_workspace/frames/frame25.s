...
frame25:
	...
	add x12, x12, 192	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 412	// cordenada X de 
    lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 148	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 172	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
...
// Pescado pintado
	...
	mov x3, 315 // Posicion X
	mov x4, 405 // Posicion Y
	mov x5, 640 
	mul x4, x4, x5		//
	add x3, x3, x4		//	
