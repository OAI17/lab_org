...
///////////////////////////////////////////
	...
	add x12, x12, 408	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 506	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 594	// cordenada X de 
    lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 284	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 198	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 282	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
