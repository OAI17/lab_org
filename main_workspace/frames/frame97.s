...
frame97:
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 590	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 675	// cordenada X de 
    lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 338	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x12, 290		// cordenada Y de 160 hasta 420
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 450	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	mov x2, 70			// Altura montaNa
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 228	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
