...
frame18:
	...
	add x12, x12, 164	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 266	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula la "esquina" izquierda del barco
	add x12, x12, 384	// cordenada X de 
    lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 174	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 140	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
	...
	movz x13, 640		// 
	mul x12, x12, x13	// calcula el centro del barco
	add x12, x12, 158	// cordenada X de 
	lsl x12, x12, 2		//
	add x12,x20,x12     // 
